...
Our computational lab uses deep neural networks and language representations to integrate and model bioinformatics and clinical data. We have a focus on cancer but draw from all relevant areas of biology. Current work centres on **multi-omics data integration** — genomics, transcriptomics, proteomics and metabolomics combined with pathway knowledge from resources such as KEGG and Reactome — and on **computational histopathology**, where we apply deep learning to tissue images alongside molecular data. Read more on the [Research](/research/) page.
...
<ul class="timeline">
  ...
  <li><span class="when">1996</span><span>DPhil in Physics, University of York.</span></li>
  <li><span class="when">1991</span><span>BSc (Hons) Mathematics and Computer Science, Heriot-Watt University.</span></li>
</ul>

## Selected publications

- Menegollo M, et al. (2024). Multi-state gene cluster switches determine the adaptive mitochondrial and metabolic landscape of breast cancer. *Cancer Research.* [doi](https://doi.org/10.1158/0008-5472.can-23-3172)
- Viñas R, Andrés-Terré H, Liò P, **Bryson K** (2022). Adversarial generation of gene expression data. *Bioinformatics* 38(3). [doi](https://doi.org/10.1093/bioinformatics/btab035)
- Bentham RB, **Bryson K**, Szabadkai G (2017). MCbiclust: a novel algorithm to discover large-scale functionally related gene sets from massive transcriptomics data collections. *Nucleic Acids Research* 45(15). [doi](https://doi.org/10.1093/nar/gkx590)
- Buchan DWA, Minneci F, Nugent TCO, **Bryson K**, Jones DT (2013). Scalable web services for the PSIPRED Protein Analysis Workbench. *Nucleic Acids Research* 41(W1). [doi](https://doi.org/10.1093/nar/gkt381)
- McGuffin LJ, **Bryson K**, Jones DT (2000). The PSIPRED protein structure prediction server. *Bioinformatics* 16(4). [doi](https://doi.org/10.1093/bioinformatics/16.4.404)
